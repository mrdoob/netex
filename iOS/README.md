...
- Network panel using injected `fetch` / `XMLHttpRequest` capture, blob preview storage, and lazy image/model previews with two-finger orbit drag for local model inspection.
